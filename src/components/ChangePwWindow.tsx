      ...
      <div className="flex-1 flex justify-center p-8 bg-white">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600">Enter your current password and set a new one to keep your account secure</p>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              >
                {form.formState.isSubmitting ? "Changing Password..." : "Continue"}
              </Button>
            </form>
          </Form>
        </div>
